...
public class SnakeMovement : MonoBehaviour
{
    ...
    void Update()
    {
        if (nextObj != null && !isPaused) // && !levelInfo.GetComponent<LevelInfo>().isPaused
        {
            ...
            nextObj.GetComponent<TailPartsMovement>().trajectory.Enqueue(nextPosForTailPart);
        }
    ...
    public void AddNewTailPart()
    {
        ...
        tailParts[tailParts.Count - 1].GetComponent<TailPartsMovement>().firstPos = firstPosForTailPart;
    }
